...
export function PricingSection() {
  const plans = [
    {
      name: "Starter",
      description: "Perfect for small teams and communities starting with chat.",
      price: "$49",
    ...
    {
      name: "Pro",
      description: "Ideal for growing teams that need advanced collaboration.",
      price: "$99",
      duration: "one-time payment",
      features: [
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Choose the plan that's right for your team and start chatting with clarity and speed.
              </p>
            </div>
          </div>
        </ScrollReveal>
