"use client"
import { MessageSquare, Lock, Image as ImageIcon, Search, Sparkles, Users } from "lucide-react"
  ...
  const features = [
    {
      ...
      description: "Blazing‑fast messages with typing indicators, read receipts, threads, and channels.",
      progress: 100,
    ...
    },
    {
      ...
      title: "Rich Media",
      description: "Share images, files, code blocks, and reactions with a delightful UX.",
      progress: 90,
    ...
    },
    {
      ...
      description: "Find people, messages, and channels quickly with advanced filters.",
      progress: 95,
    ...
    },
    {
      ...
      description: "Granular permissions, secure storage, and strong privacy controls for your org.",
      progress: 100,
    ...
    },
    {
      ...
      title: "Smart Assist",
      description: "AI‑assisted summaries and suggestions to speed up your workflow.",
      progress: 85,
    ...
    },
    {
      ...
      description: "Flexible spaces for teams and communities with presence and mentions.",
      progress: 92,
        ...
        <ScrollReveal>
          <div className="flex flex-col items-center justify-center space-y-6 text-center mb-12">
            <div className="space-y-4">
              <AnimatedText
                text="Features Built for Modern Chat"
                variant="heading"
                className="text-3xl font-heading font-bold tracking-tighter sm:text-5xl gradient-text"
                animation="slide"
              />
              <AnimatedText
                text="Everything your team needs to collaborate in real‑time with clarity, speed, and security."
                variant="paragraph"
