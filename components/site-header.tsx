...
import { AuthModalLauncher } from "@/components/auth/auth-modals"
    ...
    >
      <div className="container px-4 md:px-6 flex h-16 items-center justify-between">
        <Link href="/" className="flex items-center space-x-2 z-10">
          ...
          <span className="font-heading text-xl tracking-tight">XGNZ Chat</span>
        </Link>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-2">
            <AuthModalLauncher variant="ghost" size="sm" className="neumorphic-button" />
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-border">
                <Link href="/" className="flex items-center space-x-2" onClick={closeMobileMenu}>
                  <Icons.logo className="h-6 w-6" />
                  <span className="font-heading text-lg">XGNZ Chat</span>
                </Link>
                <button
